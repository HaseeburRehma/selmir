...
export const metadata: Metadata = {
  title: "Datenschutzerklärung — Selmir Suljkanovic",
};
  ...
  return (
    <LegalPage title="Datenschutzerklärung">
      ...
      <p>
        ...
        Datenschutz entnimmst du unserer unter diesem Text aufgeführten
      ...
      <p>
        ...
        Websitebetreiber. Dessen Kontaktdaten kannst du dem Abschnitt „Hinweis
      ...
      <p>
        ...
        Kontaktformular eingibst.
      </p>
      <p>
        Andere Daten werden automatisch oder nach deiner Einwilligung beim Besuch
        der Website durch unsere IT-Systeme erfasst. Das sind vor allem
        technische Daten (z. B. Internetbrowser, Betriebssystem oder Uhrzeit des
        Seitenaufrufs). Die Erfassung dieser Daten erfolgt automatisch, sobald du
        diese Website betrittst.
      </p>
      <p>
        <strong>Wofür nutzen wir deine Daten?</strong>
        <br />
        Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der
        Website zu gewährleisten. Andere Daten können zur Analyse deines
      ...
      <p>
        ...
        Datenverarbeitung erteilt hast, kannst du diese Einwilligung jederzeit für
        die Zukunft widerrufen. Außerdem hast du das Recht, unter bestimmten
      ...
      <p>
        Detaillierte Informationen zu diesen Analyseprogrammen findest du in der
      ...
      <p>
        ...
        lit. a DSGVO und § 25 Abs. 1 TDDDG, soweit die Einwilligung die Speicherung
        von Cookies oder den Zugriff auf Informationen im Endgerät des Nutzers (z.
        B. Device-Fingerprinting) im Sinne des TDDDG umfasst. Die Einwilligung ist
      ...
      <h3>Datenschutz</h3>
      <p>
        Die Betreiber dieser Seiten nehmen den Schutz deiner persönlichen Daten
        sehr ernst. Wir behandeln deine personenbezogenen Daten vertraulich und
        entsprechend den gesetzlichen Datenschutzvorschriften sowie dieser
        Datenschutzerklärung.
      </p>
      <p>
        Wenn du diese Website benutzt, werden verschiedene personenbezogene Daten
        erhoben. Personenbezogene Daten sind Daten, mit denen du persönlich
        identifiziert werden kannst. Die vorliegende Datenschutzerklärung
      ...
      <address>
        ...
        45130 Essen
        <br />
        Telefon: <a href="tel:020149869220">0201 - 498 692 20</a>
        <br />
        E-Mail: <a href="mailto:info@sh-wachstum.de">info@sh-wachstum.de</a>
      </address>
      <p>
      ...
      <p>
        ...
        Speicherdauer genannt wurde, verbleiben deine personenbezogenen Daten bei
        uns, bis der Zweck für die Datenverarbeitung entfällt. Wenn du ein
        berechtigtes Löschersuchen geltend machst oder eine Einwilligung zur
        Datenverarbeitung widerrufst, werden deine Daten gelöscht, sofern wir
        keine anderen rechtlich zulässigen Gründe für die Speicherung deiner
      ...
      <p>
        Sofern du in die Datenverarbeitung eingewilligt hast, verarbeiten wir
        deine personenbezogenen Daten auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO
        ...
        lit. a DSGVO. Sofern du in die Speicherung von Cookies oder in den Zugriff
        auf Informationen in dein Endgerät (z. B. via Device-Fingerprinting)
        eingewilligt hast, erfolgt die Datenverarbeitung zusätzlich auf Grundlage
        von § 25 Abs. 1 TDDDG. Die Einwilligung ist jederzeit widerrufbar. Sind
        deine Daten zur Vertragserfüllung oder zur Durchführung vorvertraglicher
        Maßnahmen erforderlich, verarbeiten wir deine Daten auf Grundlage des Art.
        6 Abs. 1 lit. b DSGVO. Des Weiteren verarbeiten wir deine Daten, sofern
        diese zur Erfüllung einer rechtlichen Verpflichtung erforderlich sind, auf
        Grundlage von Art. 6 Abs. 1 lit. c DSGVO. Die Datenverarbeitung kann ferner
      ...
      <p>
        ...
        sind. Wenn diese Tools aktiv sind, können deine personenbezogene Daten in
        diese Staaten übertragen und dort verarbeitet werden. Wir weisen darauf
        hin, dass in datenschutzrechtlich unsicheren Drittstaaten kein mit der EU
      ...
      <p>
        ...
        Übermittlungen an Drittstaaten einschließlich der Datenempfänger findest du
      ...
      <p>
        ...
        denen eine Verarbeitung beruht, entnimmst du dieser Datenschutzerklärung.
      ...
      <p>
        Werden deine personenbezogenen Daten verarbeitet, um Direktwerbung zu
        betreiben, so hast du das Recht, jederzeit Widerspruch gegen die
        Verarbeitung dich betreffender personenbezogener Daten zum Zwecke
        derartiger Werbung einzulegen; dies gilt auch für das Profiling, soweit es
        mit solcher Direktwerbung in Verbindung steht. Wenn du widersprichst,
        werden deine personenbezogenen Daten anschließend nicht mehr zum Zwecke der
      ...
      <p>
        ...
        personenbezogenen Daten zu verlangen. Hierzu kannst du dich jederzeit an
      ...
      <p>
        ...
        vertraulicher Inhalte, wie zum Beispiel Bestellungen oder Anfragen, die du
        an uns als Seitenbetreiber sendest, eine SSL- bzw. TLS-Verschlüsselung.
      ...
      <p>
        ...
        du an uns übermitteln, nicht von Dritten mitgelesen werden.
      </p>
      ...
      <p>
        ...
        Datenpakete und richten auf deinem Endgerät keinen Schaden an. Sie werden
        entweder vorübergehend für die Dauer einer Sitzung (Session-Cookies) oder
        dauerhaft (permanente Cookies) auf deinem Endgerät gespeichert.
        Session-Cookies werden nach Ende deines Besuchs automatisch gelöscht.
        Permanente Cookies bleiben auf deinem Endgerät gespeichert, bis du diese
        selbst löschst oder eine automatische Löschung durch deinen Webbrowser
        erfolgt.
      </p>
      <p>
      ...
      <p>
        ...
        zur Bereitstellung bestimmter, von dir erwünschter Funktionen (z. B. für
      ...
      <p>
        ...
        informiert wirst und Cookies nur im Einzelfall erlaubst, die Annahme von
        Cookies für bestimmte Fälle oder generell ausschließt sowie das
        automatische Löschen der Cookies beim Schließen des Browsers aktivierst. Bei
        der Deaktivierung von Cookies kann die Funktionalität dieser Website
        eingeschränkt sein.
      </p>
      <p>
        Welche Cookies und Dienste auf dieser Website eingesetzt werden, kannst du
        dieser Datenschutzerklärung entnehmen.
      </p>

      <h3>Einwilligung mit Klaro</h3>
      <p>
        Unsere Website nutzt die Consent-Technologie von Klaro, um Ihre
        ...
        dokumentieren. Anbieter dieser Technologie ist KIProtect GmbH, Bismarckstr.
        10-12, 10625 Berlin, Deutschland (im Folgenden „Klaro“).
      </p>
      <p>
        Wenn Sie unsere Website betreten, wird eine Verbindung zu den Servern von
        Klaro hergestellt, um Ihre Einwilligungen und sonstigen Erklärungen zur
        Cookie-Nutzung einzuholen. Anschließend speichert Klaro einen Cookie in
        Ihrem Browser, um Ihnen die erteilten Einwilligungen bzw. deren Widerruf
        zuordnen zu können. Die so erfassten Daten werden gespeichert, bis Sie uns
        zur Löschung auffordern, den Klaro-Cookie selbst löschen oder der Zweck für
        die Datenspeicherung entfällt. Zwingende gesetzliche Aufbewahrungspflichten
        bleiben unberührt.
      </p>
      <p>
        Der Einsatz von Klaro erfolgt, um die gesetzlich vorgeschriebenen
      ...
      <p>
        ...
        sogenannten Server-Log-Dateien, die dein Browser automatisch an uns
      ...
      <p>
        Wenn du uns per E-Mail, Telefon oder Telefax kontaktierst, wird deine
        Anfrage inklusive aller daraus hervorgehenden personenbezogenen Daten
        (Name, Anfrage) zum Zwecke der Bearbeitung deines Anliegens bei uns
      ...
      <p>
        ...
        b DSGVO, sofern deine Anfrage mit der Erfüllung eines Vertrags zusammenhängt
        ...
        lit. f DSGVO) oder auf deiner Einwilligung (Art. 6 Abs. 1 lit. a DSGVO)
        sofern diese abgefragt wurde; die Einwilligung ist jederzeit widerrufbar.
      </p>
      <p>
        Die von dir an uns per Kontaktanfragen übersandten Daten verbleiben bei uns,
        bis du uns zur Löschung aufforderst, deine Einwilligung zur Speicherung
        widerrufst oder der Zweck für die Datenspeicherung entfällt (z. B. nach
        abgeschlossener Bearbeitung deines Anliegens). Zwingende gesetzliche
      ...
      <p>
        Des Weiteren können wir mit Google Analytics u. a. deine Maus- und
      ...
      <p>
        ...
        Cookies oder Device-Fingerprinting). Die von Google erfassten Informationen
        über die Benutzung dieser Website werden in der Regel an einen Server von
        Google in den USA übertragen und dort gespeichert.
      </p>
      <p>
        Die Nutzung dieses Dienstes erfolgt auf Grundlage deiner Einwilligung nach
      ...
      <p>
        ...
        Weitere Informationen erhältst du vom Anbieter unter folgendem Link:{" "}
        <a
      ...
      <p>
        Mehr Informationen zum Umgang mit Nutzerdaten bei Google Analytics findest
        du in der Datenschutzerklärung von Google:{" "}
        <a
      ...
      <p>
        Diese Website nutzt die Funktionen von Google Ads Remarketing. Anbieter ist
        die Google Ireland Limited („Google“), Gordon House, Barrow Street, Dublin
        4, Irland.
      </p>
      <p>
        ...
        anschließend interessenbezogene Werbung im Google-Werbenetzwerk anzeigen zu
        lassen (Remarketing bzw. Retargeting).
      </p>
      <p>
        ...
        Nutzungs- und Surfverhaltens auf einem Endgerät (z. B. Handy) an dich
        angepasst wurden auch auf einem anderen deiner Endgeräte (z. B. Tablet oder
        PC) angezeigt werden.
      </p>
      <p>
        Wenn du über einen Google-Account verfügst, kannst du der personalisierten
      ...
      <p>
        Weitergehende Informationen und die Datenschutzbestimmungen findest du in
      ...
      <p>
        ...
        Google Ads Remarketing. Hierbei übergeben wir bestimmte Kundendaten (z. B.
        ...
        passende Werbebotschaften innerhalb des Google-Netzwerks (z. B. bei YouTube,
      ...
      <p>
        Mithilfe von Google-Conversion-Tracking können Google und wir erkennen, ob
        der Nutzer bestimmte Aktionen durchgeführt hat. So können wir beispielsweise
        auswerten, welche Buttons auf unserer Website wie häufig geklickt und welche
        Produkte besonders häufig angesehen oder gekauft wurden. Diese Informationen
        dienen dazu, Conversion-Statistiken zu erstellen. Wir erfahren die
        Gesamtanzahl der Nutzer, die auf unsere Anzeigen geklickt haben und welche
        Aktionen sie durchgeführt haben. Wir erhalten keine Informationen, mit denen
