...
/**
 * "Kostenlose Vertriebs-Potenzialanalyse" — 2nd conversion point on the
 * Handwerker-Painpoints LP. Identical layout to LpOffer; only the form
 * card is swapped for the 4-field variant that writes to the campaign
 * segment.
 */
export default function LpOfferPainpoints() {
  return (
