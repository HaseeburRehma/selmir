/**
 * Brand glyphs for the footer social row (lucide dropped brand icons in v1).
 * Single-path marks, drawn in currentColor so they inherit the link colour.
 */
...
export function SpotifyIcon({ className = "" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden className={className}>
      <path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.66 0 12 0m5.5 17.31c-.22.36-.68.47-1.03.25-2.82-1.72-6.37-2.11-10.55-1.16-.4.09-.8-.16-.89-.56s.16-.8.56-.89c4.57-1.04 8.49-.59 11.66 1.34.36.22.47.68.25 1.02m1.47-3.27c-.27.44-.85.58-1.29.31-3.23-1.98-8.15-2.56-11.97-1.4-.5.15-1.02-.13-1.17-.62s.13-1.02.62-1.17c4.36-1.32 9.78-.68 13.49 1.6.44.27.58.85.32 1.28m.13-3.41C15.15 8.3 8.87 8.09 5.25 9.19c-.59.18-1.22-.15-1.4-.75s.15-1.22.75-1.4c4.16-1.26 11.1-1.02 15.48 1.58.53.31.7 1 .38 1.53-.31.53-1 .7-1.53.38" />
    </svg>
  );
}
