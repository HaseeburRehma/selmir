...
/**
 * Whitepaper subscribe form — same 2-step SMS-verify UX as LeitfadenForm.
 *
 * Flow:
 ...
 *   2. User types the 6-digit code, clicks "Whitepaper kostenlos sichern"
 *      → POST /api/whitepaper/subscribe {name, phone, email, code}
      ...
      if (res?.ok) {
        ...
        try {
          window.fbq?.("track", "Lead", {
            content_name: "Whitepaper – Angebotsprozess",
    ...
    return (
      <div className="flex flex-col items-start gap-2 rounded-[14px] border border-purple-2/30 bg-purple-2/[0.06] p-5 text-white">
        ...
        <p className="font-body text-[14px] leading-[1.55] text-white/70">
          Das Whitepaper ist unterwegs. Wenn es in ein paar Minuten nicht ankommt,
